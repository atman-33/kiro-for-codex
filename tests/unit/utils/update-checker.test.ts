...
describe('UpdateChecker', () => {
    ...
    describe('GitHub API Integration', () => {
        it('should fetch latest release from GitHub API', async () => {
            const mockRelease = {
                tag_name: 'v0.1.8',
                name: 'Release v0.1.8',
                html_url: 'https://github.com/atman-33/kiro-for-cc/releases/tag/v0.1.8',
                body: 'Release notes'
            };
    ...
    describe('User Interactions', () => {
        ...
        it('should open changelog when "View Changelog" is clicked', async () => {
            ...
            expect(vscode.env.openExternal).toHaveBeenCalledWith(
                vscode.Uri.parse('https://github.com/atman-33/kiro-for-cc/releases/latest')
            );
        });
    ...
    describe('Real API Test (Manual)', () => {
        it.skip('should actually fetch from GitHub API', async () => {
            ...
            const response = await fetch('https://api.github.com/repos/atman-33/kiro-for-cc/releases/latest');
